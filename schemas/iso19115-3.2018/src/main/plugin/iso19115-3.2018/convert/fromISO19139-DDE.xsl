<xsl:stylesheet version="2.0"
    ...
    <xsl:import href="utilityDDE/create19115-3NamespacesDDE.xsl"/>
    <xsl:import href="utilityDDE/dateTimeDDE.xsl"/>
    <xsl:import href="utilityDDE/multiLingualCharacterStringsDDE.xsl"/>
    
    <xsl:include href="utilityDDE/ISO19139mappingDDE/coreDDE.xsl"/>
    <xsl:include href="utilityDDE/ISO19139mappingDDE/CI_ResponsiblePartyDDE.xsl"/>
    <xsl:include href="utilityDDE/ISO19139mappingDDE/CI_CitationDDE.xsl"/>
    <xsl:include href="utilityDDE/ISO19139mappingDDE/SRV_DDE.xsl"/>
    <xsl:include href="utilityDDE/ISO19139mappingDDE/DQ_DDE.xsl"/>
